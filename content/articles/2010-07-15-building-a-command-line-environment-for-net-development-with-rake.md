...
Ruby Gems are small software libraries that extent the functionality of the core language. In most Ruby projects, a large number of Gem dependencies are usually needed, and [Bundler](http://gembundler.com/) was written to help manage these dependencies for individual projects.
