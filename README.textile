...
Compile the site with @nanoc compile@, and it should deploy according to rules in @config.yaml@. Create a new article from a template with @rake create:article title="my new article t itle"@.
