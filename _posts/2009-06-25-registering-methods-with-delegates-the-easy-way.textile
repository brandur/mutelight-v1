...
I mention this because I feel that the shorthand syntax is preferable in a number of ways, including simply that it's shorter and eliminates some of the normal boilerplate cruft, leaving you with more readable code. It's also easier to understand for developers new to C#. Consider the following:
